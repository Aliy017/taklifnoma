...
export const sparkleThemes: Record<SparkleThemeId, SparkleThemeConfig> = {
  ...
  "variant-3": {
    ...
    accent: "#c9a087",
    highlight: "#ffd700",
    sparkles: ["#ffd700", "#fff8e7", "#f5e6c8", "#ffe4b5", "#ffffff", "#c9a087"],
    halo: "rgba(255, 215, 0, 0.22)",
    twinkle: "#fff8e7",
  ...
  "variant-5": {
    ...
    accent: "#c9a087",
    highlight: "#f5e6d8",
    sparkles: ["#ffffff", "#fff8f0", "#f5f0e8", "#e8ecf2", "#ffffff"],
  ...
  "variant-6": {
    ...
    accent: "#d4af37",
    highlight: "#ffd700",
    sparkles: ["#ffd700", "#ef4444", "#fff5f0", "#c41e3a", "#f87171", "#d4af37"],
    halo: "rgba(196, 30, 58, 0.28)",
    twinkle: "#ffd700",
    twinkleGlow: "rgba(239, 68, 68, 0.85)",
  },
  "variant-7": {
    base: "#5c3d45",
    mid: "#b8876a",

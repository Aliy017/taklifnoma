...
export default function Hero() {
  const { groom, bride, displayDate, displayTimeLabel } = variant3Config;
        ...
        <LuxuryFrame size="lg">
          <div className="text-center">
            ...
            <SparkleHeading
              ...
              as="h1"
              intensity="high"
              className="v3-gold-text text-3xl font-light tracking-wide sm:text-5xl"
            >
              {groom} &amp; {bride}
            </SparkleHeading>

            <div className="v3-divider mx-auto my-6 max-w-[120px]" />
            ...
            <CouplePortrait theme="variant-3" className="mb-8" />

            <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
              <span className="v3-chip rounded-full px-4 py-2">{displayDate}</span>
              <span className="v3-chip rounded-full px-4 py-2">{displayTimeLabel}</span>
            </div>
          </div>
        </LuxuryFrame>
      </div>
